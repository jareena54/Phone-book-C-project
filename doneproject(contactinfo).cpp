...
void modifyfun(){
	...
	fclose(fptr);
	fclose(fptr1);
	fptr=fopen("jareena.txt","w");
	fclose(fptr);
	fptr=fopen("jareena.txt","a");
...
void exitfun(){
	system("cls");
	gotoxy(31,4);
	printf("\xDB\xDB\xDB\xDB EXIT OF CONTACT DICTIONARY \xDB\xDB\xDB\xDB");
}
void password(void){
	char passwords[20]={"system"};
	gotoxy(22,2);
	int i;
	int j;
...
void menu(){
	system("cls");
	gotoxy(30,1);
	printf("\xB3\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xDB PHONEBOOK DIRECTORY \xDB\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB2\xB3");
	gotoxy(31,4);
	printf("\xB3\xDB\xDB\xDB\xDB\xDB\xDB\xDB\xDB 1.Add New Contact");
	gotoxy(31,7);
